package com.igloosec.app.exceptions;

import com.igloosec.app.dto.response.ErrorResponse;
...
public class DefaultExceptionHandler {
    ...
    public @ResponseBody
    ErrorResponse unknownExceptionHandler(HttpServletRequest request, Exception e){
